...
with open(sfile, 'a',encoding='utf-8',newline='') as csvfile:
    ...
    webbrowser.get('firefox').open_new_tab(url='http://aphcaa.in/telephone-directory/')
    time.sleep(15)
